...
void insertarAlInicio(struct Lista &, struct DiaContagio);
//void insertarAlFinal(struct Lista &, int);
//void insertarEnOrden(struct Lista &, int);

struct Nodo * crearNodo(struct DiaContagio elemento, struct Nodo *);
...
struct DiaContagio retornaCabeza(const struct Lista &);

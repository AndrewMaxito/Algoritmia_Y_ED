...
void insertarAlInicio(struct Lista & tad, struct DiaContagio elemento) {
...
struct Nodo * crearNodo(struct DiaContagio elemento, struct Nodo * siguiente) {
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->elemento = elemento;
...
struct DiaContagio retornaCabeza(const struct Lista & tad){

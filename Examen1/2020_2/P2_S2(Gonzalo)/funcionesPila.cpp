...
struct DiaContagio desapilar(struct Pila & pila){
	...
	exit(1); //O cualquier otro valor que no se encuentre en la pila
        ...
        struct DiaContagio elemento = cima(pila);
...
struct DiaContagio cima(const struct Pila & pila){

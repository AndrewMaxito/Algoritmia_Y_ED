...
void insertarAlInicio(struct Lista & tad, struct StrEfectivo policia) {

    /*Se va cambiar por la función crear nodo*/
    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->policia = policia;
...
struct StrEfectivo retornaCabeza(const struct Lista & tad){
    return tad.cabeza->policia;
}

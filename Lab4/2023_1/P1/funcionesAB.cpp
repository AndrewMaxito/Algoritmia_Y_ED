...
struct NodoArbol * crearNuevoNodo(struct NodoArbol * izquierda, const Servidor &elemento,
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct NodoArbol * izquierda, 
                         const Servidor &elemento, struct NodoArbol * derecha) {
...
void plantarArbolBinario(struct NodoArbol *& raiz, 
                    struct NodoArbol * izquierda, const Servidor &elemento, 
                    struct NodoArbol * derecha){
...
void plantarArbolBinario(struct ArbolBinario & arbol, struct ArbolBinario & arbolIzquierda, 
                         const Servidor &elemento, struct ArbolBinario & arbolDerecha) {
...
void imprimirNodo(struct NodoArbol * raiz){
    cout<<setw(5)<<raiz->elemento.letra << "-" << raiz->elemento.velocidad;
}
